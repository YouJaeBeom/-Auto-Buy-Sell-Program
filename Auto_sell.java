...
/*매도하는 클래스*/
public class Auto_sell {
	static String order_id;
	static String data;
	public static String autosell(String coin_name,String price)
	{
			...
			try {
			    ...
			    double coin_count1=Double.parseDouble(balance); //내가 가진 코인 갯수 파악하기
			    double coin_count=coin_count1*0.99;
			    ...
			    rgParams1.put("order_currency", coin_name);// 코인명 바꾸기~~~~~~~~~~~~~~~``
			    rgParams1.put("units", units);
			    Integer price1=Integer.valueOf(price);
		    	rgParams1.put("price",price1); // 코인 수
			    rgParams1.put("type","ask"); // 코인 수
			    result = api.callApi_sell("/trade/place", rgParams1);
